...
Master catalog of 73 concepts. One-line summaries for LLM navigation.
...
- **[Codex](/knowledge/codex)** [medium] — OpenAI's foundational code-generation model that pioneered AI-assisted programming and inspired modern coding assistants.
...
- **[Fine-Tuning](/knowledge/fine-tuning)** [high] — The process of further training a pre-trained AI model on specialized data to improve performance on specific tasks.
...
- **[Blast Radius Management](/knowledge/blast-radius)** [high] — Limiting the potential damage from AI agent errors by controlling scope and permissions.
- **[Copilot](/knowledge/copilot)** [medium] — AI assistants that augment human productivity by providing real-time suggestions and automating routine tasks.
- **[Dark Code](/knowledge/dark-code)** [high] — Production code that no human has ever fully understood — AI-generated, automatically tested, and deployed without a comprehension step.
- **[Disposable Software](/knowledge/disposable-software)** [high] — Software built quickly with AI for a specific purpose, designed to be thrown away rather than maintained.
- **[Sniff-Checking](/knowledge/sniff-checking)** [high] — The meta-skill of rapidly evaluating AI-generated output for correctness without re-deriving it from scratch.
- **[Specification Quality](/knowledge/specification-quality)** [high] — The skill of writing precise, complete specifications that AI systems can reliably execute.
- **[The 5 Levels of AI Coding](/knowledge/ai-coding-levels)** [high] — A framework mapping the progression from manual coding through vibe coding to full agent orchestration.
- **[Vibe Coding](/knowledge/vibe-coding)** [high] — A development approach where developers describe intent in natural language and let AI write the code.
...
- **[The Permission Gap](/knowledge/permission-gap)** [high] — The organizational and psychological barrier where professionals wait for external validation before adopting AI.
- **[The Solo Operator](/knowledge/solo-operator)** [high] — Individuals using AI to operate at the scale of a small company, building products and services alone.
- **[The Three-Week Cliff](/knowledge/three-week-cliff)** [high] — The phenomenon where most professionals abandon AI tools after approximately three weeks of use.
- **[Three Layers of Work](/knowledge/three-layers-of-work)** [high] — A framework dividing work into execution, judgment, and strategy layers to predict AI's impact on jobs.

## Prompting

- **[Prompt Engineering](/knowledge/prompt-engineering)** [high] — Techniques for crafting effective prompts to get better results from LLMs.
