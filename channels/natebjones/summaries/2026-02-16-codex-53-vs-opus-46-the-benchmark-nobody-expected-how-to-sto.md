...
- Codex 5.3 scores 77.3% on Terminal Bench 2.0 vs Opus 4.6 at 65.4%, is the first model to receive a "high capability" cybersecurity classification, and is the first frontier model that helped build itself -- earlier versions debugged training code and optimized the pipeline that produced the final model. [04:40](https://www.youtube.com/watch?v=41UDGsBEjoI&t=280)
- Claude's agent teams feature genuine peer-to-peer coordination with 13 distinct operations for spawning, assigning, and communicating between agents, while Codex runs parallel but independent agents -- making Claude better suited for interdependent work like product launches where deliverables reference each other. [16:08](https://www.youtube.com/watch?v=41UDGsBEjoI&t=968)
- The meta-skill that matters most is not picking one tool but developing the capacity to quickly evaluate new capabilities and restructure workflows accordingly, since the underlying technology changes faster than anyone can fully absorb. [25:00](https://www.youtube.com/watch?v=41UDGsBEjoI&t=1500)
